                        ...
                        <div class="md:grid md:grid-cols-3 md:gap-4 mx-2 my-6">
                            @foreach($doctors as $doctor)
                                <div class="card border-2">
                                    <div>
                                        <img class="w-24 h-24 rounded-full p-2 mx-auto" src=" {{ $doctor->photo  ?? asset('images/logo.png') }} " alt="{{ $doctor->title }} {{ $doctor->name }} Image">    
                                    </div>
                                    ...
                                    <div class="flex justify-end border-t pt-4 pb-2 items-center">
                                        ...
                                        &nbsp;
                                        <form action="{{ route('edit.doctor', $doctor->id) }}" >
                                            @csrf 
